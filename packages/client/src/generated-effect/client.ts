...
const Endpoint4_0 = (raw: RawClient["server.team"]) => () =>
  raw["team.listRuns"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_1Request = Parameters<RawClient["server.team"]["team.createRun"]>[0]
type Endpoint4_1Input = {
  readonly sessionID: Endpoint4_1Request["payload"]["sessionID"]
  readonly teamName: Endpoint4_1Request["payload"]["teamName"]
}
const Endpoint4_1 = (raw: RawClient["server.team"]) => (input: Endpoint4_1Input) =>
  raw["team.createRun"]({ payload: { sessionID: input["sessionID"], teamName: input["teamName"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_2Request = Parameters<RawClient["server.team"]["team.getRun"]>[0]
type Endpoint4_2Input = { readonly runID: Endpoint4_2Request["params"]["runID"] }
const Endpoint4_2 = (raw: RawClient["server.team"]) => (input: Endpoint4_2Input) =>
  raw["team.getRun"]({ params: { runID: input["runID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_3Request = Parameters<RawClient["server.team"]["team.listTasks"]>[0]
type Endpoint4_3Input = { readonly runID: Endpoint4_3Request["params"]["runID"] }
const Endpoint4_3 = (raw: RawClient["server.team"]) => (input: Endpoint4_3Input) =>
  raw["team.listTasks"]({ params: { runID: input["runID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_4Request = Parameters<RawClient["server.team"]["team.getTask"]>[0]
type Endpoint4_4Input = {
  readonly runID: Endpoint4_4Request["params"]["runID"]
  readonly taskID: Endpoint4_4Request["params"]["taskID"]
}
const Endpoint4_4 = (raw: RawClient["server.team"]) => (input: Endpoint4_4Input) =>
  raw["team.getTask"]({ params: { runID: input["runID"], taskID: input["taskID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
const adaptClient = (raw: RawClient) => ({
  ...
  "server.team": adaptGroup4(raw["server.team"]),

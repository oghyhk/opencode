...
import type {
  ...
  V2TeamRunCancelErrors,
  V2TeamRunCancelResponses,
  V2TeamRunCreateErrors,
  V2TeamRunCreateResponses,
  V2TeamRunGetErrors,
  V2TeamRunGetResponses,
  V2TeamRunListErrors,
  V2TeamRunListResponses,
  V2TeamTaskGetErrors,
  V2TeamTaskGetResponses,
  V2TeamTaskListErrors,
  V2TeamTaskListResponses,
  VcsApplyErrors,
  VcsApplyResponses,
  VcsDiffErrors,
  VcsDiffRawErrors,
...
export class Run extends HeyApiClient {
   ...
   * List team runs
   *
   * Retrieve all execution team runs.
   */
  public list<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).get<V2TeamRunListResponses, V2TeamRunListErrors, ThrowOnError>({
      url: "/api/team/run",
      ...options,
    })
  }
   ...
   * Create team run
   *
   * Create and schedule a new team run for a session.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      sessionID?: string
    ...
    return (options?.client ?? this.client).post<V2TeamRunCreateResponses, V2TeamRunCreateErrors, ThrowOnError>({
      url: "/api/team/run",
      ...options,
      ...params,
      headers: {
  ...
  public get<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<V2TeamRunGetResponses, V2TeamRunGetErrors, ThrowOnError>({
   ...
   * Cancel team run
   *
   * Cancel an active team run and its running tasks.
   */
  public cancel<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "path", key: "runID" }] }])
    return (options?.client ?? this.client).post<V2TeamRunCancelResponses, V2TeamRunCancelErrors, ThrowOnError>({
...
export class Task extends HeyApiClient {
   ...
   * List tasks for run
   *
   * Retrieve all planned/executed tasks for a team run.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters: {
      runID: string
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "path", key: "runID" }] }])
    return (options?.client ?? this.client).get<V2TeamTaskListResponses, V2TeamTaskListErrors, ThrowOnError>({
   ...
   * Get team task
   *
   * Retrieve a specific team task within a run.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      runID: string
    ...
    return (options?.client ?? this.client).get<V2TeamTaskGetResponses, V2TeamTaskGetErrors, ThrowOnError>({

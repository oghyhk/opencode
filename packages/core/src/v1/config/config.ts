...
export const Info = Schema.Struct({
  ...
  team_defaults: Schema.optional(ConfigTeam.TeamConfig),
  team: Schema.optional(Schema.Record(Schema.String, ConfigTeam.TeamConfig)),
  default_team: Schema.optional(Schema.String),

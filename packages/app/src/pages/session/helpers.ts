...
export const createSessionTabs = (input: TabsInput) => {
  ...
  const teamOpen = createMemo(() => input.tabs().active() === "team" || input.tabs().all().includes("team"))
  ...
  const panelTabs = createMemo(
    () => {
      ...
      return input
        ...
        .all()
        .flatMap((tab) => {
          if (tab === "context" || tab === "review" || tab === "team") return []
  ...
  const activeTab = createMemo(() => {
    ...
    if (active === "context" || active === "team") return active
